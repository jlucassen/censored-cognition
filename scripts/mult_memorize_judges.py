...
for solver_result_name in solver_result_names:
    ...
    solver_results_3 = [solver_results_3_flat[i*batch:(i+1)*batch] for i in range(int(len(solver_results_3_flat)/batch))]
    solver_results_4 = [solver_results_4_flat[i*batch:(i+1)*batch] for i in range(int(len(solver_results_4_flat)/batch))]
